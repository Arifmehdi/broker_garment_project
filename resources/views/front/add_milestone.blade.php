    ...
    <div class="page-title">
        <div class="container">
          <div class="page-caption">
            <h2>Add Milestone</h2>
            <p><a href="#" title="Home">Dashboard</a> <i class="ti-angle-double-right"></i> Add Milestone</p>
          </div>
        </div>
      </div>
    <!-- ======================= End Page Title ===================== -->
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="profile_detail_block">
                        <div class="card">
                    <form action="{{route('store_milestone')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                               <label for="">Upload Image (Jobfile)</label>  
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="">Upload Vedio (Jobfile)</label>  
                                <input type="file" name="job_video"  class="form-control">
                                @error('photo')
                                <span style="color:red">{{$message}}</span>
                                @enderror
                            </td>
