...
<div>
    ...
    <a href="" class="btn btn-success">Cash Withdraw</a>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <h3>Machant</h3>
                        <strong> Company Name : {{$deals->marchant->companies->name}}</strong><br>
                        <strong> Email : {{$deals->marchant->companies->email}}</strong><br>
                        <strong> Address : {{$deals->marchant->companies->address}}</strong><br>
                    ...
                    <div class="col-md-4 col-xl-4">
                        <h3>Seller</h3>
                        <strong> Company Name : {{$deals->seller->usermachines->company->name}}</strong><br>
                        <strong> Email : {{$deals->seller->usermachines->company->email}}</strong><br>
                        <strong> Address : {{$deals->seller->usermachines->company->address}}</strong><br>
