            ...
            <div class="form-group">
                  ...
                  <select name="merchant_id" id="" >
                    {{-- <option value="">Select Merchant Company</option> --}}
                      <option value="{{$edit_deal->workorderID->companies->id}}">{{$edit_deal->workorderID->companies->name}}</option>
                ...
                <div class="form-group">
                      ...
                      <select name="seller_id" id="">
                        {{-- <option value="">Select Seller Company</option> --}}
                          <option value="{{$edit_deal->machinepostID->usermachine->companyName->id}}">{{$edit_deal->machinepostID->usermachine->companyName->name}}</option>
