            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <!-- <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{route('add_cat')}}">Add Categories</a></li>
                        </ul>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{route('machine_post')}}">Machine Post</a></li>
                        </ul> -->
                    ...
                    <!-- <li>
                        <a href="javascript: void(0);" class="waves-effect">
                            ...
                            <span> Machine Post </span>
                            <span class="menu-arrow"></span>
                        </a>

                        <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('addo_machinepost')}}">Machine Post</a></li>
                        </ul>
                        <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('machinepost')}}">Machine Post List</a></li>
                        </ul>
                    </li> -->
