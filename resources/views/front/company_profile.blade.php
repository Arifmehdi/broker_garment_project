...
<nav class="navbar navbar-default navbar-mobile navbar-fixed light bootsnav">
  <div class="container"> 
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html"> <img src="{{asset('Front_Assets/img/logo.png')}}" class="logo logo-display" alt=""> <img src="{{asset('Front_Assets/img/logo.png')}}" class="logo logo-scrolled" alt=""> </a> 
  </div>
  ...
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-md-8 col-sm-7">
        ...
        <div class="row">
        <div class="col-md-4 text-center user_profile_img"> <img src="{{asset('photos/company/'.$data->photo)}}" class="width-100"  alt=""/>
    ...
    <div class="detail-wrapper">
          ...
          <div class="col-md-3 " style="padding-top:15px">
            ...
            <img src="{{asset('photos/company/'.$p)}}" alt="" style="height:150px;width:150px">
            </div>
            @endforeach
            </div>
        ...
        <div class="detail-wrapper">
          ...
          <div class="col-md-3 " style="padding-top:15px">
            ...
            <img src="{{asset('photos/company/'.$data->trade_license)}}" alt="" style="height:200px;width:200px">
            </div>
            <ul class="detail-list">
