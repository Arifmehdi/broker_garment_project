                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="inbox-widget slimscroll" style="min-height: 384px;">
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="{{asset('admin_assets/images/users/avatar-6.jpg')}}" class="rounded-circle" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="{{asset('admin_assets/images/users/avatar-8.jpg')}}" class="rounded-circle" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="{{asset('admin_assets/images/users/avatar-9.jpg')}}" class="rounded-circle" alt=""></div>
                                ...
                                <ul class="conversation-list slimscroll" style="min-height: 330px;">
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            <img src="{{asset('admin_assets/images/users/avatar-1.jpg')}}" alt="male">
                                            <i>10:00</i>
                                        </div>
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{asset('admin_assets/images/users/avatar-5.jpg')}}" alt="Female">
                                            <i>10:01</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{asset('admin_assets/images/users/avatar-5.jpg')}}" alt="male">
                                            <i>10:02</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
