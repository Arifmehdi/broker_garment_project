    ...
    <div class="container"> 
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
          ...
          <li class="dropdown active"> <a href="{{route('index')}}">About</a> </li>
          <li class="dropdown active"> <a href="{{route('index')}}">Service</a> </li>
          <li class="dropdown active"> <a href="{{route('index')}}">FAQ</a> </li>
        ...
        @guest
                        ...
                        @else
                                ...
                                <li>
                                    ...
                                    <li class="br-right"><a class="btn-signup red-btn" ><i class="login-icon ti-user"></i>{{ Auth::user()->name }}</a></li>
